...
export default function BookDetailClient({ courseId, bookId }: BookDetailClientProps) {
    ...
    return (
      <div className="flex justify-center items-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-gray-600">L'URL richiesto non è valido</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border">
              ...
              <div className="space-y-3">
                <Button onClick={startStudySession} fullWidth className="group">
                  <Play className="h-4 w-4 mr-2 group-hover:scale-110 transition-transform" />
                  Inizia Sessione di Studio
                </Button>

                {book.materials && book.materials.length > 0 && (
                  <Link href={`/courses/${courseId}/study?book=${bookId}&pdf=${encodeURIComponent(book.materials[0].filename)}`}>
                ...
                <Link href={`/chat?course=${courseId}&book=${bookId}`}>
                  <Button variant="success" fullWidth className="group">
                    <MessageSquare className="h-4 w-4 mr-2 group-hover:scale-110 transition-transform" />
                    Chat con il Tutor
                  </Button>
                </Link>

                <Link href={`/courses/${courseId}/books/${bookId}/mindmap`}>
                  <Button variant="secondary" fullWidth className="group">
